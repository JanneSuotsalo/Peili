...
const Modal = ({ isShowing, hide, item, buyItem, errorMsg, goBack }) =>
  isShowing
        ...
        <React.Fragment>
          ...
          <div className="shop_modal_wrapper">
            <div className="shop_modal">
              <div
                className="shop_modal_img"
                style={{ background: item.color }}
              ></div>
              <div className="shop_modalName">{item.name}</div>
              ...
              <div className="shop_buttonContainers">
                <div className="shop_modal_backButton_container">
                  <button
                    type="button"
                    className="shop_modal_close_button"
                    onClick={() => goBack()}
                  >
                ...
                <div className="shop_modal_buyButton_container">
                  <button
                    type="button"
                    className="shop_modal_buy_button"
