  ...
  render() {
    return (
      <div className="profileHeader">
        ...
        <h4> Rahaa: {this.props.money}G</h4>
        <p>{this.props.title}</p>
        <div className="accountDetail" onClick={this.clicked}>
          <MdPersonOutline size={30} />
          <p>Käyttäjän tiedot</p>
          <div className="buttonProfile">
            <Arrow anim={this.state.showAnim} />
          </div>
        </div>
        <Collapse isOpened={this.state.showAnim}>
          <div className="userDetails">
            <p>Syntymäaika: {this.props.user.birth}</p>
            <p>Puhelin: {this.props.user.phone}</p>
          </div>
        </Collapse>
        ...
        <div className="statisticsDetail" onClick={this.clicked1}>
          <TiDocument size={30} />
          <p>Statistiikkaa</p>
          <div className="buttonProfileStat">
            <Arrow anim={this.state.showAnim1} />
          </div>
        </div>
        <Collapse isOpened={this.state.showAnim1}>
          <div className="StatDetails">
            <p>Testejä tehty: {this.props.user.Tests}</p>
            <p>Tilatut kanavat: {this.props.user.subscribed}</p>
            <p>Liittynyt: 21.11.2019</p>
          </div>
        </Collapse>
      </div>
    );
